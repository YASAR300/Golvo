  ...
  return (
    <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
      <div className="max-w-md w-full p-6 sm:p-8 rounded-xl bg-[#0F1011] border border-white/[0.08] text-center space-y-4 shadow-xl">
        ...
        <div>
          <h2 className="text-base font-semibold text-white">Dashboard Encountered an Issue</h2>
          <p className="text-xs text-[#8A8F98] mt-1">
            {error?.message || "Failed to load dashboard data. Please verify your connection."}
          </p>
        </div>
